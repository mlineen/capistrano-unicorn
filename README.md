...
- `:unicorn_address`
    ...
    Address where unicorn listen to. May be in the form of HOST:PORT or PATH, HOST:PORT is taken to mean a TCP socket and PATH is meant to be a path to a UNIX domain socket. Defaults to "0.0.0.0:8080"
